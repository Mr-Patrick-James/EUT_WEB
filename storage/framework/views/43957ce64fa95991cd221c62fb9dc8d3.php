...
<nav class="topnav">
    <div class="topnav-inner">
        ...
        <div class="nav-actions">
            ...
            <a href="<?php echo e(route('shop.cart')); ?>" class="nav-icon-btn" style="color:#9ca3af;">
                <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                </svg>
                <span class="cart-badge-dot" id="cartBadge" style="display:none;">0</span>
            </a>
            <a href="<?php echo e(route('shop.profile')); ?>" class="nav-icon-btn" style="color:#facc15;">
                <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="hero">
    <div class="hero-card">
        ...
        <img src="<?php echo e(asset('images/DeliveryPanda.png')); ?>" alt="Delivery Panda" class="hero-img">
    </div>
</div>
...
<div class="cats-wrap">
    <div style="max-width:1200px; margin:0 auto; padding:14px 0 14px 16px; display:flex; gap:10px; overflow-x:scroll; overflow-y:visible; -webkit-overflow-scrolling:touch; scrollbar-width:none; flex-wrap:nowrap; -ms-overflow-style:none;" id="catsRow">
        ...
        <button class="cat-pill" data-category="<?php echo e($cat->slug); ?>" style="flex-shrink:0;">
            <span style="font-size:17px; line-height:1;"><?php echo e($iconMap[$cat->icon] ?? '🍽️'); ?></span> <?php echo e($cat->name); ?>
...
<div class="products-grid" id="productsGrid">
    ...
    <div class="p-card" data-category="<?php echo e($item->category->slug ?? ''); ?>" data-name="<?php echo e(strtolower($item->name)); ?>" style="animation-delay: <?php echo e($index * 0.04); ?>s;">
        <a href="<?php echo e(route('shop.product', $item->id)); ?>" style="text-decoration:none; display:block;">
            <div class="p-card-img-wrap">
                <img src="<?php echo e($item->image ? asset($item->image) : 'https://placehold.co/400x300/1a1a2e/facc15?text=' . urlencode($item->name)); ?>" alt="<?php echo e($item->name); ?>" class="p-card-img" loading="lazy">
            ...
            <div class="p-card-body">
                <p class="p-card-name"><?php echo e($item->name); ?></p>
                <p class="p-card-desc"><?php echo e($item->description); ?></p>
                <div class="p-card-price-row">
                    <span class="p-card-price">₱<?php echo e(number_format($item->price, 0)); ?></span>
                    <span class="p-card-sold"><?php echo e(rand(200,4800)); ?>+ sold</span>
                </div>
            </div>
        </a>
    </div>
...
<nav class="bottom-nav">
    <div class="bottom-nav-inner">
        <a href="<?php echo e(route('shop.home')); ?>" class="bnav-item active">
...
<?php /**PATH C:\Users\patri\Desktop\EUT_WEB\resources\views/shop/index.blade.php ENDPATH**/ ?>