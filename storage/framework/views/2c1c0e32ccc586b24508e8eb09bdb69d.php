...
<body>
    ...
    <div class="left-panel">
        <img src="<?php echo e(asset('images/phone.png')); ?>" alt="EUT App" class="phone-img">
    </div>

    <!-- RIGHT: content -->
    <div class="right-panel">

        <img src="<?php echo e(asset('images/DeliveryPanda.png')); ?>" alt="Delivery Panda" class="panda-img">
        ...
        <a href="<?php echo e(route('restaurant')); ?>" class="btn-proceed">
            Proceed Anyway
        </a>
...
<?php /**PATH C:\Users\patri\Desktop\EUT_WEB\resources\views/landing.blade.php ENDPATH**/ ?>