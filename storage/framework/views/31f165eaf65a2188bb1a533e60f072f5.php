...
<nav class="nav" id="mainNav">
    <a href="<?php echo e(route('restaurant')); ?>" class="nav-brand">
    ...
    <div class="nav-actions">
        <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('shop.home')); ?>" class="btn-primary" style="padding:8px 20px;font-size:13px;">Dashboard →</a>
        <?php else: ?>
...
<div class="mobile-menu" id="mobileMenu">
    ...
    <?php if(auth()->guard()->check()): ?>
        <a href="<?php echo e(route('shop.home')); ?>">Dashboard →</a>
    <?php else: ?>
...
<section class="hero" id="hero">
    ...
    <div class="hero-inner">
        <div class="hero-left">
            ...
            <div class="hero-btns">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('shop.home')); ?>" class="btn-primary">Order Now →</a>
                <?php else: ?>
        ...
        <div class="hero-right">
            <div class="hero-panda-wrap">
                <img src="<?php echo e(asset('images/DeliveryPanda1.png')); ?>" alt="EUT Delivery Mascot" class="hero-panda">
...
<section class="menu-section" id="menu">
    <div style="max-width:1160px;margin:0 auto;">
        ...
        <div class="menu-grid" id="menuGrid">
            ...
            <div class="menu-card" data-cat="healthy">
                <div class="menu-card-img-wrap">
                    <img src="<?php echo e(asset('images/combo-meal.jpg')); ?>" alt="Greek Salad" class="menu-card-img">
            ...
            <div class="menu-card" data-cat="desserts">
                <div class="menu-card-img-wrap">
                    <img src="<?php echo e(asset('images/delicious-burger-fries.jpg')); ?>" alt="Freshly Baked Cake" class="menu-card-img">
            ...
            <div class="menu-card" data-cat="fastfood">
                <div class="menu-card-img-wrap">
                    <img src="<?php echo e(asset('images/gourmet-burger.jpg')); ?>" alt="Crispy Burger Combo" class="menu-card-img">
            ...
            <div class="menu-card" data-cat="main">
                <div class="menu-card-img-wrap">
                    <img src="<?php echo e(asset('images/hero-burger.jpg')); ?>" alt="Pasta Carbonara" class="menu-card-img">
            ...
            <div class="menu-card" data-cat="main">
                <div class="menu-card-img-wrap">
                    <img src="<?php echo e(asset('images/combo-meal.jpg')); ?>" alt="Grilled Chicken Rice" class="menu-card-img">
                    <span class="menu-badge badge-green"><svg width="9" height="9" fill="none" stroke="#fff" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg> Best Seller</span>
                </div>
                <div class="menu-card-body">
                    <div class="menu-card-cat">Main Course</div>
            ...
            <div class="menu-card" data-cat="drinks">
                <div class="menu-card-img-wrap">
                    <img src="<?php echo e(asset('images/french-fries.jpg')); ?>" alt="Mango Shake" class="menu-card-img">
            ...
            <div class="menu-card" data-cat="main">
                <div class="menu-card-img-wrap">
                    <img src="<?php echo e(asset('images/restaurant-interior.jpg')); ?>" alt="Beef Sinigang" class="menu-card-img">
            ...
            <div class="menu-card" data-cat="desserts">
                <div class="menu-card-img-wrap">
                    <img src="<?php echo e(asset('images/hero-bg.jpg')); ?>" alt="Chocolate Lava Cake" class="menu-card-img">
        ...
        <div style="text-align:center;margin-top:44px;">
            <a href="<?php echo e(route('shop.home')); ?>" class="btn-primary" style="font-size:15px;padding:14px 36px;">View Full Menu →</a>
        </div>
    </div>
</section>
    ...
    <div style="max-width:1160px;margin:0 auto;">
        ...
        ">
            ...
            <div class="loc-thumb" onclick="openLightbox(0)" style="grid-column:span 2; grid-row:span 2;">
                <img src="<?php echo e(asset('images/restaurant-interior.jpg')); ?>" alt="EUT Interior" style="width:100%;height:100%;object-fit:cover;">
            ...
            <div class="loc-thumb" onclick="openLightbox(1)">
                <img src="<?php echo e(asset('images/gourmet-burger.jpg')); ?>" alt="Gourmet Burger" style="width:100%;height:100%;object-fit:cover;">
                <div class="loc-thumb-overlay">
            ...
            <div class="loc-thumb" onclick="openLightbox(2)">
                <img src="<?php echo e(asset('images/combo-meal.jpg')); ?>" alt="Combo Meal" style="width:100%;height:100%;object-fit:cover;">
                <div class="loc-thumb-overlay">
            ...
            <div class="loc-thumb" onclick="openLightbox(3)">
                <img src="<?php echo e(asset('images/delicious-burger-fries.jpg')); ?>" alt="Burger & Fries" style="width:100%;height:100%;object-fit:cover;">
                <div class="loc-thumb-overlay">
            ...
            <div class="loc-thumb" onclick="openLightbox(4)" style="position:relative;">
                <img src="<?php echo e(asset('images/french-fries.jpg')); ?>" alt="More Photos" style="width:100%;height:100%;object-fit:cover;">
                <div class="loc-thumb-overlay" style="background:rgba(0,0,0,0.6);">
                    <div style="text-align:center;">
                        <div style="font-size:22px;font-weight:900;color:#facc15;">+<?php echo e(3); ?></div>
...
<script>
const lbImages = [
    { src: '<?php echo e(asset("images/restaurant-interior.jpg")); ?>', caption: 'Our Place — EUT Snack House' },
    { src: '<?php echo e(asset("images/gourmet-burger.jpg")); ?>',      caption: 'Signature Burger' },
    { src: '<?php echo e(asset("images/combo-meal.jpg")); ?>',          caption: 'Combo Meal' },
    { src: '<?php echo e(asset("images/delicious-burger-fries.jpg")); ?>', caption: 'Burger & Fries' },
    { src: '<?php echo e(asset("images/french-fries.jpg")); ?>',        caption: 'Crispy French Fries' },
    { src: '<?php echo e(asset("images/hero-burger.jpg")); ?>',         caption: 'Fresh Burger' },
    { src: '<?php echo e(asset("images/hero-bg.jpg")); ?>',             caption: 'EUT Snack House Vibes' },
];
let lbCurrent = 0;
...
<section class="cta-section">
    <img src="<?php echo e(asset('images/DeliveryPanda.png')); ?>" alt="" class="cta-deco-panda">
    <div class="cta-inner">
        <div class="cta-left">
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('shop.home')); ?>" class="btn-cta">Join Now →</a>
            <?php else: ?>
...
<footer class="footer">
    <div class="footer-top">
        <a href="<?php echo e(route('restaurant')); ?>" class="footer-brand">
            <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="flex-shrink:0;"><path stroke-linecap="round" stroke-linejoin="round" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/></svg>
            EUT Restaurant
        </a>
        <nav class="footer-nav">
            ...
            <a href="<?php echo e(route('shop.home')); ?>">Order Now</a>
        </nav>
    ...
    <div class="auth-modal">
        ...
        <div class="auth-body">
            ...
            <div class="auth-panel active" id="loginPanel">
                ...
                <a href="<?php echo e(route('auth.google')); ?>" class="auth-google">
...
async function doLogin() {
    ...
    try {
        const res  = await fetch('<?php echo e(route("auth.login")); ?>', {
            method: 'POST',
            headers: {
...
async function doSignup() {
    ...
    try {
        const res  = await fetch('<?php echo e(route("auth.signup")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php /**PATH C:\Users\patri\Desktop\EUT_WEB\resources\views/restaurant.blade.php ENDPATH**/ ?>