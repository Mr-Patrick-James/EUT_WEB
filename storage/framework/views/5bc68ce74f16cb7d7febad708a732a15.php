...
<div class="page-body">
    ...
    <div id="emptyCart" style="display:none;">
        <div class="empty-state">
            ...
            <div class="empty-suggestions">
                <a href="<?php echo e(route('shop.home')); ?>" class="suggestion-chip">🍔 Burgers</a>
                <a href="<?php echo e(route('shop.home')); ?>" class="suggestion-chip">🍟 Fries</a>
                <a href="<?php echo e(route('shop.home')); ?>" class="suggestion-chip">🥤 Beverages</a>
                <a href="<?php echo e(route('shop.home')); ?>" class="suggestion-chip">🍱 Combos</a>
            </div>
            <a href="<?php echo e(route('shop.home')); ?>" class="checkout-btn" style="max-width:280px; margin:0 auto;">
                Browse Menu
            </a>
        </div>
    </div>
    ...
    <div id="cartContent" style="display:none;">
        ...
        <div class="card">
            ...
            <div style="padding:14px 0 0;">
                ...
                <div class="upsell-scroll">
                    <a href="<?php echo e(route('shop.home')); ?>" class="upsell-chip">
                        <img src="<?php echo e(asset('images/french-fries.jpg')); ?>" class="upsell-img" alt="Fries">
                        <div><p class="upsell-name">Crispy Fries</p><p class="upsell-price">₱120</p></div>
                    </a>
                    <a href="<?php echo e(route('shop.home')); ?>" class="upsell-chip">
                        <img src="<?php echo e(asset('images/combo-meal.jpg')); ?>" class="upsell-img" alt="Combo">
                        <div><p class="upsell-name">Combo Meal</p><p class="upsell-price">₱390</p></div>
                    </a>
                    <a href="<?php echo e(route('shop.home')); ?>" class="upsell-chip">
                        <img src="<?php echo e(asset('images/gourmet-burger.jpg')); ?>" class="upsell-img" alt="Burger">
                        <div><p class="upsell-name">Gourmet Burger</p><p class="upsell-price">₱420</p></div>
                    </a>
                    <a href="<?php echo e(route('shop.home')); ?>" class="upsell-chip">
                        <img src="<?php echo e(asset('images/hero-burger.jpg')); ?>" class="upsell-img" alt="Classic">
        ...
        <!-- Sticky Buy Now Bar -->
        <a href="<?php echo e(route('shop.checkout')); ?>" class="buy-now-bar" id="buyNowBar">
        ...
        <a href="<?php echo e(route('shop.home')); ?>" class="continue-btn">
            ← Continue Shopping
        </a>
...
<nav class="bottom-nav">
    <div class="bottom-nav-inner">
        ...
        <a href="<?php echo e(route('shop.cart')); ?>" class="bnav-item active">
            <svg width="22" height="22" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\Users\patri\Desktop\EUT_WEB\resources\views/shop/cart.blade.php ENDPATH**/ ?>